 ...
 * 
 * @export
 * @interface AppSchemasGeneralJobsJobDetailOutJobDetailOut
 */
export interface AppSchemasGeneralJobsJobDetailOutJobDetailOut {
    /**
     * ID
     * @type {number}
     * @memberof AppSchemasGeneralJobsJobDetailOutJobDetailOut
     */
    id: number;
    /**
     * 
...
/**
 * Check if a given object implements the AppSchemasGeneralJobsJobDetailOutJobDetailOut interface.
 */
export function instanceOfAppSchemasGeneralJobsJobDetailOutJobDetailOut(value: object): boolean {
    let isInstance = true;
...
export function AppSchemasGeneralJobsJobDetailOutJobDetailOutFromJSON(json: any): AppSchemasGeneralJobsJobDetailOutJobDetailOut {
    return AppSchemasGeneralJobsJobDetailOutJobDetailOutFromJSONTyped(json, false);
}

export function AppSchemasGeneralJobsJobDetailOutJobDetailOutFromJSONTyped(json: any, ignoreDiscriminator: boolean): AppSchemasGeneralJobsJobDetailOutJobDetailOut {
...
export function AppSchemasGeneralJobsJobDetailOutJobDetailOutToJSON(value?: AppSchemasGeneralJobsJobDetailOutJobDetailOut | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
